...
Core::make('help')->display(t(
	'You have requested deletion of a user that is the owner of some blog pages. '
	. 'We have made it possible to control what to do with these blog pages.<br><br>'
	. 'You can either choose to delete alle the blog pages that belong to this user, '
	. 'or you can assign a new user as the owner of these blog pages.'
));
?>
